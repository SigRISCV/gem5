...
int sbox_use = 2;
text_t check_box[3] = {0xc003b93999b33765ULL, 0x270a787275c48d10ULL,
                       0x5c06a7501b63b2fdULL};

int m = MAX_LENGTH / 16;

const_t alpha = 0xC0AC29B7C97C50DDULL;
const_t c[8] = {0x0000000000000000ULL, 0x13198A2E03707344ULL,
...
void
text2cell(cell_t *cell, text_t is)
{
    char *byte_ptr = reinterpret_cast<char *>(&is);
...
text_t
pseudo_reflect(text_t is, qkey_t tk)
{
    cell_t cell[16];
    text2cell(cell, is);
...
text_t
forward(text_t is, qkey_t tk, int r)
{
    is ^= tk;
    cell_t cell[16];
    text2cell(cell, is);
...
text_t
backward(text_t is, qkey_t tk, int r)
{
    cell_t cell[16];
    text2cell(cell, is);
...
text_t
qarma64_enc(text_t plaintext, tweak_t tweak, qkey_t w0, qkey_t k0, int rounds)
{
...
text_t
qarma64_dec(text_t plaintext, tweak_t tweak, qkey_t w0, qkey_t k0, int rounds)
{
    qkey_t w1 = w0;
